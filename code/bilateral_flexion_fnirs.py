...
def bilateral_flexion(fxs, baud_rate, exp_time = 9*60, time_step=1/100):
	...
	for i in range(num_time_steps):
		if i < 11:
			...
			try:
				...
				if curr_time - int(curr_time/(3*60))*3*60 < 1.5*60:
					if exo_on == 1:
						print("Exo off")
						exo_on = 0
					motor_torque_0 = 0
	...
	file1=open("S10_session5_fNIRS.txt","a+")
	file1.write("Zero setpoints\n")
	file1.write(str(zero_setpoint_0)+" "+ str(zero_setpoint_1) + "\n")
	#file1.truncate(0)
